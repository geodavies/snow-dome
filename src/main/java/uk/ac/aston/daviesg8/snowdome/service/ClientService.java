...
public class ClientService {
  ...
  /**
   * Finds the client from the database for a given username and password and adds it to the current
   * session. If the client can't be found then an exception is thrown.
   *
   ...
   */
  public void addClientToSession(HttpSession httpSession, String username, String password)
  ...
  /**
   * Checks if the client already exists and if they don't then it inserts them into the database.
   * If the client already exists then an exception is thrown.
   *
   * @param username the username of the client
   * @param password the password of the client
