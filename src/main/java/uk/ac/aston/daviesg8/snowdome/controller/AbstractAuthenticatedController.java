...
/**
 * This class contains shared functionality across all controllers which require client
 * authentication
 */
public abstract class AbstractAuthenticatedController {
  ...
  /**
   * Checks whether or not there is a client associated with the sessions. If the user is not logged
   * in then a ClientNotLoggedInException is thrown.
   *
